...
"}")
        ...
        sizePolicy1.setHeightForWidth(self.splitter_14.sizePolicy().hasHeightForWidth())
        self.splitter_14.setSizePolicy(sizePolicy1)
        ...
        sizePolicy4.setHeightForWidth(self.pushButton_test_speed.sizePolicy().hasHeightForWidth())
        self.pushButton_test_speed.setSizePolicy(sizePolicy4)
        ...
        sizePolicy1.setHeightForWidth(self.lineEdit_ip1.sizePolicy().hasHeightForWidth())
        self.lineEdit_ip1.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.lineEdit_mac1.sizePolicy().hasHeightForWidth())
        self.lineEdit_mac1.setSizePolicy(sizePolicy1)
